...
| 4 | **Version skew** — brain serves 1.3.0 knowledge against an installed 1.1.0 | Open, no prior art | Pre-build the graph per release in CI; match served knowledge to the user's lockfile. Phase 2 gate | `BRAIN_PLAN.md` risk R3 |
